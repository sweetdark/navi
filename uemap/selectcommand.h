 ...
 * smartpoint@sohu.com
 */
#ifndef _UEMAP_SELECTCMD_H
#define _UEMAP_SELECTCMD_H
...
namespace UeMap
{
	...
	*
	*/
    class UEMAP_CLASS CSelectCommand : public CViewCommand
    {
    public:
        //
        //
        ...
        *
        */
        CSelectCommand(CViewImpl *navView) : CViewCommand(navView)
        {
        }
    ...
    private:
        ...
        const static short m_pickLimitation;
        const static short m_pickExtent;
    };
}
