 ...
 * smartpoint@sohu.com
 */
#ifndef _UEMAP_LINEDEMOLAYER_H
#define _UEMAP_LINEDEMOLAYER_H
...
namespace UeMap
{
	...
	*
	*/
    class UEMAP_CLASS CLineDemoLayer : public CViewLayer
    {
    public:
        //
        //
        ...
        *
        */
        CLineDemoLayer(short layerIdx, int scale, CViewImpl *view, const tstring &file);

        /**
        *
        */
        virtual ~CLineDemoLayer();
