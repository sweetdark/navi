 ...
 * smartpoint@sohu.com
 */
#ifndef _UEMAP_POINTDEMOLAYER_H
#define _UEMAP_POINTDEMOLAYER_H
...
namespace UeMap
{
	...
	*
	*/
    class UEMAP_CLASS CPointDemoLayer : public CViewLayer
    {
    public:
        //
        //
        ...
        *
        */
        CPointDemoLayer(short layerIdx, int scale, CViewImpl *view, const tstring &file);

        /**
        *
        */
        virtual ~CPointDemoLayer();
