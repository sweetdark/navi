 ...
 * smartpoint@sohu.com
 */
#ifndef _UEMAP_POLYDEMOLAYER_H
#define _UEMAP_POLYDEMOLAYER_H
...
namespace UeMap
{
	...
	*
	*/
    class UEMAP_CLASS CPolyDemoLayer : public CViewLayer
    {
    public:
        //
        //
        ...
        *
        */
        CPolyDemoLayer(short layerIdx, int scale, CViewImpl *view, const tstring &file);

        /**
        *
        */
        virtual ~CPolyDemoLayer();
