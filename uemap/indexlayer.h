 ...
 * smartpoint@sohu.com
 */
#ifndef _UEMAP_INDEXLAYER_H
#define _UEMAP_INDEXLAYER_H
...
namespace UeMap
{
	...
	*
	*/
    class UEMAP_CLASS CIndexLayer : public CViewLayer
    {
    public:
        //
        //
        ...
        *
        */
        CIndexLayer(short layerIdx, int scale, CViewImpl *view, const tstring &file);
