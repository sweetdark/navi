 ...
 * smartpoint@sohu.com
 */
#ifndef _UEINDEX_RECTINDEX_H
#define _UEINDEX_RECTINDEX_H
...
namespace UeIndex
{
	...
	*/
	class UEINDEX_CLASS CGeoRectIndex : public CGeoIndexImpl
    {
		// Disallow implicitly creation etc
		CGeoRectIndex(const CGeoRectIndex &other);
		const CGeoRectIndex &operator=(const CGeoRectIndex &other);
    ...
    public:
        ...
        //
        /**
        * In advance to define "layer-tile" structure based on index file
        */
        CGeoRectIndex(const tstring &indexFile, GeoLayer &curLayer, bool isTiled = false);

        /**
        *
        */
        virtual ~CGeoRectIndex();
