...
//#if _IS_PC
//        platform_support(pix_format_e format=agg::pix_format_rgb565, bool flip_y=true);
//#else
		platform_support(pix_format_e format=agg::pix_format_rgb565, bool flip_y=false);
//#endif
