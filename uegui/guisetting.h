...
#ifndef _UEGUI_GUISETTING_H
#define _UEGUI_GUISETTING_H
...
namespace UeGui
{
  class UEGUI_CLASS CGuiSettings : public UeBase::CUeSettingsIO
  {
  public:
    //
    // 构造&析构
   ...
   ~CGuiSettings();
		...
		* \brief 读取对象
		*/
    static CGuiSettings* GetGuiSettings();
		/*!
		* \brief 释放对象
		*/
		void Delete();
  ...
  private:
    // 静态对象
    static CGuiSettings* m_guiSettings;
    // 地图设置
